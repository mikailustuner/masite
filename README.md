...
Betik `.env.homeserver` yoksa güçlü rastgele secret’larla otomatik oluşturur; imajları build eder, PostgreSQL runtime rolünü kurar, migration’ları uygular, private evidence bucket’ını ve ilk owner hesabını oluşturur, health check başarılı olana kadar bekler. Ardından arayüz:
